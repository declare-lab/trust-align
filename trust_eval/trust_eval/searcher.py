...
class SearcherWithinDocs:
    ...
    def search(self, query: str) -> int:
        ...
        if self.retriever == "tfidf":
            ...
            similarities = [
                cosine_similarity(tfidf_doc, tfidf_query)
                for tfidf_doc in self.tfidf_docs
            ]
            ...
            score = (
                torch.matmul(self.embeddings, q_embed.t())
                .squeeze(1)
                .detach()
                .cpu()
                .numpy()
            ...
            score = np.array(
                [
                    self.get_entailment_score(format_document(doc), claim)
    ...
    def get_entailment_score(self, passage: str, claim: str) -> float:
        ...
        for i, score in enumerate(scores):
            ...
            token_id = generated_ids[
                0, i + 1
            ]  # +1 because the first token is the input token
